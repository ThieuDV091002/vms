...
@Component({
  selector: 'app-top-scrap-reasons-chart-widget',
  template: `
...
export class TopScrapReasonsChartWidgetComponent implements OnInit, OnChanges, OnDestroy {
  ...
  ngOnChanges(changes: SimpleChanges): void {
    ...
    if (changes.selected) {
      this.scrapSettings = {
        ...
        excludeScrapReasons: changes.selected.currentValue?.extraProperties?.excludeScrapReasons ?? [],
  ...
  saveSettingsAndFilter() {
    const requestBody: any = {
      ...
      name: this.scrapSettings.name,
      description: this.selected.description,
      tenantId: this.selected.tenantId,
      displayName: this.selected.displayName,
      id: this.selected.id,
      extraProperties: {
        hideTitle: this.scrapSettings.hideTitle,
        refreshRate: this.scrapSettings.refreshRate,
        excludeScrapReasons: this.scrapSettings.excludeScrapReasons,
        sort: this.scrapSettings.sort
      }
    };
