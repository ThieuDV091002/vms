...
@Component({
  selector: 'app-site-huddle-monthly-view',
  templateUrl: './site-huddle-monthly-view.component.html',
  styleUrl: './site-huddle-monthly-view.component.scss'
})
export class SiteHuddleMonthlyViewComponent implements OnInit {
  ...
  ngOnChanges(): void {
    this.areas = this.selectedDataTier?.areas;
    this.cells = this.selectedDataTier?.cells;
  }
