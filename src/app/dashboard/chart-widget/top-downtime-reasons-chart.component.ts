...
@Component({
  selector: 'app-top-downtime-reasons-chart',
  template: `
...
export class TopDowntimeReasonsChartComponent implements OnInit, OnChanges, OnDestroy{
  ...
  saveSettings() {
    localStorage.setItem('topDowntimeReasonsSettings', JSON.stringify(this.downtimeSettings));
