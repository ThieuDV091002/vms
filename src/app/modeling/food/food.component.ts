...
import { FoodDto } from '@apis/vms/dtos/food';
import { FoodService } from '@apis/vms/services';
...
export class FoodComponent implements OnInit {
  ...
  data: PagedResultDto<FoodDto> = { items: [], totalCount: 0 };
  form: FormGroup;
  columns = [
  ...
  ngOnInit(): void {
    this.hookToQuery();
    this.localizationService.get('::LABEL_Food').subscribe(data => {
      this.info = data
    });
  }
