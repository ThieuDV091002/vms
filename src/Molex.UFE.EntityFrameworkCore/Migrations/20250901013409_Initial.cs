...
namespace Molex.UFE.Migrations
{
    /// <inheritdoc />
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_mlx_Areas", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_mlx_Cells", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_mlx_Corporates", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_mlx_Divisions", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SAPSiteCode = table.Column<string>(type: "text", nullable: false),
                    ExtraProperties = table.Column<string>(type: "text", nullable: false),
                    ConcurrencyStamp = table.Column<string>(type: "character varying(40)", maxLength: 40, nullable: false),
                    CreationTime = table.Column<DateTime>(type: "timestamp without time zone", nullable: false),
                    CreatorId = table.Column<Guid>(type: "uuid", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_mlx_Sites", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "mlx_WorkCenters",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    IsDeleted = table.Column<bool>(type: "boolean", nullable: false, defaultValue: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_mlx_WorkCenters", x => x.Id);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AbpEntityChanges_EntityId",
                table: "AbpEntityChanges",
                column: "EntityId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AbpEntityPropertyChanges_PropertyName",
                table: "AbpEntityPropertyChanges",
                column: "PropertyName");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_mlx_Areas_Name",
                table: "mlx_Areas",
                column: "Name");

            migrationBuilder.CreateIndex(
                name: "IX_mlx_Areas_NormalizedName",
                table: "mlx_Areas",
                column: "NormalizedName");

            migrationBuilder.CreateIndex(
                name: "IX_mlx_Areas_SiteId",
                table: "mlx_Areas",
                column: "SiteId");

            migrationBuilder.CreateIndex(
                name: "IX_mlx_Cells_AreaId",
                table: "mlx_Cells",
                column: "AreaId");

            migrationBuilder.CreateIndex(
                name: "IX_mlx_Cells_Name",
                table: "mlx_Cells",
                column: "Name");

            migrationBuilder.CreateIndex(
                name: "IX_mlx_Cells_NormalizedName",
                table: "mlx_Cells",
                column: "NormalizedName");

            migrationBuilder.CreateIndex(
                name: "IX_mlx_Corporates_Name",
                table: "mlx_Corporates",
                column: "Name");

            migrationBuilder.CreateIndex(
                name: "IX_mlx_Corporates_NormalizedName",
                table: "mlx_Corporates",
                column: "NormalizedName");

            migrationBuilder.CreateIndex(
                name: "IX_mlx_Divisions_CorporateId",
                table: "mlx_Divisions",
                column: "CorporateId");

            migrationBuilder.CreateIndex(
                name: "IX_mlx_Divisions_Name",
                table: "mlx_Divisions",
                column: "Name");

            migrationBuilder.CreateIndex(
                name: "IX_mlx_Divisions_NormalizedName",
                table: "mlx_Divisions",
                column: "NormalizedName");

            migrationBuilder.CreateIndex(
                name: "IX_mlx_Sites_DivisionId",
                table: "mlx_Sites",
                column: "DivisionId");

            migrationBuilder.CreateIndex(
                name: "IX_mlx_Sites_Name",
                table: "mlx_Sites",
                column: "Name");

            migrationBuilder.CreateIndex(
                name: "IX_mlx_Sites_NormalizedName",
                table: "mlx_Sites",
                column: "NormalizedName");

            migrationBuilder.CreateIndex(
                name: "IX_mlx_WorkCenters_CellId",
                table: "mlx_WorkCenters",
                column: "CellId");

            migrationBuilder.CreateIndex(
                name: "IX_mlx_WorkCenters_Name",
                table: "mlx_WorkCenters",
                column: "Name");

            migrationBuilder.CreateIndex(
                name: "IX_mlx_WorkCenters_NormalizedName",
                table: "mlx_WorkCenters",
                column: "NormalizedName");
