...
{
    [DbContext(typeof(UFEDbContext))]
    partial class UFEDbContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Molex.UFE.Area", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("mlx_Areas", (string)null);
                });

            modelBuilder.Entity("Molex.UFE.Cell", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("mlx_Cells", (string)null);
                });

            modelBuilder.Entity("Molex.UFE.Corporate", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("mlx_Corporates", (string)null);
                });

            modelBuilder.Entity("Molex.UFE.Division", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("Corporate");

                    b.HasIndex("Name");

                    b.HasIndex("NormalizedName");

                    b.ToTable("mlx_Divisions", (string)null);
                });

            modelBuilder.Entity("Molex.UFE.Site", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("mlx_Sites", (string)null);
                });

            modelBuilder.Entity("Molex.UFE.WorkCenter", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");

                    b.Property<Guid>("Cell")
                        .HasColumnType("uuid")
                    ...
                    b.ToTable("mlx_WorkCenters", (string)null);
                });
